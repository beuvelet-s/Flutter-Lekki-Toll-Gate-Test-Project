...
class PinEntryTextFieldCustom extends StatefulWidget {
...
class PinEntryTextFieldState extends State<PinEntryTextFieldCustom> {
  List<String> _pin;
  ...
  @override
  void didUpdateWidget(PinEntryTextFieldCustom oldWidget) {
